...
class AssessmentUpdateInput {
  ...
  @ApiProperty({
    required: false,
    type: () => RiskUpdateManyWithoutAssessmentsInput,
  })
  @ValidateNested()
  @Type(() => RiskUpdateManyWithoutAssessmentsInput)
  @IsOptional()
  @Field(() => RiskUpdateManyWithoutAssessmentsInput, {
    nullable: true,
  })
  risks?: RiskUpdateManyWithoutAssessmentsInput;
}

export { AssessmentUpdateInput as AssessmentUpdateInput };
