...
@InputType()
class AssessmentCreateNestedManyWithoutApplicationsInput {
...
export { AssessmentCreateNestedManyWithoutApplicationsInput as AssessmentCreateNestedManyWithoutApplicationsInput };
