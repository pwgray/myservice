...
@InputType()
class QuestionsRIskCreateNestedManyWithoutQuestionsInput {
...
export { QuestionsRIskCreateNestedManyWithoutQuestionsInput as QuestionsRIskCreateNestedManyWithoutQuestionsInput };
